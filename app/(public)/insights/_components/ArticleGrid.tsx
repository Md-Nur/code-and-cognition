                ...
                {filteredArticles.length > 0 ? filteredArticles.map((article) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col flex-1">
                            ...
                            <span className="flex items-center gap-2 text-white/40 group-hover:text-white transition-all text-[10px] font-bold uppercase tracking-widest pt-4 border-t border-white/5">
